...
# ─── Pocket definitions ───────────────────────────────────────────────────────
POCKETS = {
    # Placeholder relative paths — replace with your local protein/ligand files.
    "8R12": {
        "protein_path": str(REPO_ROOT / "data" / "examples" / "8R12.pdbqt"),
        "ligand_path": str(REPO_ROOT / "data" / "examples" / "8R12_ligand.sdf"),
        "label": "8R12",
    },
    "7RPZ_KRAS": {
        "protein_path": str(REPO_ROOT / "data" / "examples" / "7PRZ.pdbqt"),
        "ligand_path": str(REPO_ROOT / "data" / "examples" / "7PRZ_ligand.sdf"),
