...
import random  # 导入 random，用于随机打乱。
import torch  # 导入 PyTorch。
from tqdm.auto import tqdm  # 导入 tqdm，显示进度。

from torch.utils.data import Subset  # 导入 Subset，用于构造子集。
from datasets.pl_pair_dataset import PocketLigandPairDataset  # 导入口袋-配体数据集。
