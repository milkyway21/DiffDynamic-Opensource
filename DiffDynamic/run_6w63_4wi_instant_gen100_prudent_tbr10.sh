#!/usr/bin/env bash
# 6W63 4WI：100 瞬时+完整生成（Scaffold-Prudent（非 base30））→ experiments/6w63_4wi_instant_gen100_prudent_tbr10
# Usage: bash run_6w63_4wi_instant_gen100.sh
set -eo pipefail
...
OUT="experiments/6w63_4wi_instant_gen100_prudent_tbr10"
CFG="configs/run_6w63_4wi_instant_gen100_prudent_tbr10.yml"
...
OUT = Path('experiments/6w63_4wi_instant_gen100_prudent_tbr10')
INSTANT = OUT / 'instant'
...
python3 scripts/pack_6w63_4wi_instant_gen100_prudent_tbr10.py
