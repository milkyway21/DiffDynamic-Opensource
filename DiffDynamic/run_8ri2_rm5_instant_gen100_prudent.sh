#!/usr/bin/env bash
# 8RI2 RM5：100 瞬时+完整生成（Scaffold-Prudent（非 base30））→ experiments/8ri2_rm5_instant_gen100_prudent
...
OUT="experiments/8ri2_rm5_instant_gen100_prudent"
CFG="configs/run_8ri2_rm5_instant_gen100_prudent.yml"
...
OUT = Path('experiments/8ri2_rm5_instant_gen100_prudent')
INSTANT = OUT / 'instant'
...
python3 scripts/pack_8ri2_rm5_instant_gen100_prudent.py
