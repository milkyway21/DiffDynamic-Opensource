...
OUT = Path(os.environ.get(
    'OUT_DIR',
    'experiments/6w63_4wi_ligandsize_normal_gen100_prudent_tbr10_preserve',
))
FINAL = OUT / 'final'
...
(OUT / 'README.txt').write_text(
    '6W63 4WI ligandsize-normal: 100 instant + scaffold-prudent\n'
    '================================================\n'
    ...
    'n_extra=round(N(37.44,4.30))-scaffold; placement RNG: 42+idx*9973\n'
)
