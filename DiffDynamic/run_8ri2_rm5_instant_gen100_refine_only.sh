#!/usr/bin/env bash
# 8RI2 RM5：100 瞬时+完整生成（仅 DiffDynamic refine（无 large_step/base30））→ experiments/8ri2_rm5_instant_gen100_refine_only
...
OUT="experiments/8ri2_rm5_instant_gen100_refine_only"
CFG="configs/run_8ri2_rm5_instant_gen100_refine_only.yml"
...
OUT = Path('experiments/8ri2_rm5_instant_gen100_refine_only')
INSTANT = OUT / 'instant'
...
python3 scripts/pack_8ri2_rm5_instant_gen100_refine_only.py
