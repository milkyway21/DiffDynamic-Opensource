#!/usr/bin/env bash
# 6W63 4WI：100 瞬时+完整生成（仅 DiffDynamic refine（无 large_step/base30））→ experiments/6w63_4wi_instant_gen100_refine_only_tbr10
...
OUT="experiments/6w63_4wi_instant_gen100_refine_only_tbr10"
CFG="configs/run_6w63_4wi_instant_gen100_refine_only_tbr10.yml"
...
python3 scripts/pack_6w63_4wi_instant_gen100_refine_only_tbr10.py
