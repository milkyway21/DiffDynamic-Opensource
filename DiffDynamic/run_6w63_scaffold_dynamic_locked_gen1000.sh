#!/usr/bin/env bash
# 6W63：scaffold dynamic_locked 生成 1000 → 全量评估 → n100 出图
# Usage: GPU=5 bash run_6w63_scaffold_dynamic_locked_gen1000.sh
set -eo pipefail
...
OUT="${OUT:-experiments/6w63_scaffold_dl_gen1000_gpu${GPU}_${DATE_TAG}}"
CFG_SRC="${CFG:-configs/run_6w63_scaffold_dynamic_locked_gen1000.yml}"
...
python3 scripts/select_n100_valid_and_plot.py \
  ...
  --tag 6W63_scaffold_dl_n1000 \
  --prefix 6W63_scaffold_dl_n1000 \
